...
export default function HomeScreen() {
  ...
  const { currentSong, isPlaying, isLoading: isAudioLoading, playSong, togglePlay } =
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {playlists.map((playlist) => (
                ...
                >
                  ...
                  <Text className="text-white mt-2 font-medium text-sm w-32" numberOfLines={1}>
                    {playlist.name}
                  </Text>
